...
exports.handler = async (event) => {
  ...
  try {
    ...
    // New shape: payload.reads: [{ messageId, senderId? }]
    ...
    // Normalize reads: prefer provided reads; else map messageIds -> {messageId}
    ...
    for (const t of targets) {
      ...
      // Fallback to Dynamo if senderId not provided
      ...
      // Find sender connections via GSI userId-index
      let connectionIds = [];
      try {
